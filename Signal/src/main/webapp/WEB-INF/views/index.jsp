        ...
        <header class="site-header">
            <div class="top-header-bar">
                <div class="container-fluid">
                    <div class="row"> 
                        <div class=" d-none d-md-flex flex-wrap justify-content-center justify-content-lg-start mb-3 mb-lg-0">
				               ...
				               <div class="nav-bar">
				                <div class="container">
				                   <div class="row"> 
				                      ...
				                      <!--  <div class="col-xs-6 col-md-4 d-flex flex-wrap justify-content-center justify-content-lg-end align-items-center"> --> 
